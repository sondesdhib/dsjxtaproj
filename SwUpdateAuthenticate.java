...
public class SwUpdateAuthenticate {
...
if (myNetPeerGroup!=null) {
	...
	System.err.println(" JXTA platform has failed to start: myNetPeerGroup is null");
	System.exit(1);
}
	...
	//	}
			...
			Hashtable allPurposePeerGroupServicesHashtable = (Hashtable) passwdMembershipPeerGroupParamAdv.getServices();
			...
			passwdMembershipServiceModuleImplAdv=this.createPasswdMembershipServiceModuleImplAdv
			(allPurposePeerGroupMemershipServiceModuleImplAdv);
				...
				private PeerGroup discoverPeerGroup(PeerGroup myNetPeerGroup,
						...
						membershipService.join(auth);
							...
							try {
								...
								SwUpdateAuthenticate satellaRoot = new SwUpdateAuthenticate();
								System.exit(0);
								}
}
